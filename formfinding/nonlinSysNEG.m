function [ f ] = nonlinSysNEG(x,v1,v2,v3,v4,b,NB)
% Newton-Raphson 
...
%     NB = NB-[bnmp' bnmp' bnmp' bnmp']; % Transladar para a origem do sistema de coordenadas
    ...
    f9  = (x4-x(1))^2  + (y4-x(2))^2  + (z4-x(3))^2  - v4^2; % 4
    f10 = (x1-x(4))^2  + (y1-x(5))^2  + (z1-x(6))^2  - v1^2; % 1
    f11 = (x2-x(7))^2  + (y2-x(8))^2  + (z2-x(9))^2  - v2^2; % 2
    f12 = (x3-x(10))^2 + (y3-x(11))^2 + (z3-x(12))^2 - v3^2; % 3
